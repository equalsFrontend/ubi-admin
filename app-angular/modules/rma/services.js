...
angular.module('genie.rma.services',[])

.factory('RMASearchConfig', ['APP_CONFIG', 'AuthenticationService', 'AuthInterceptor', '$translate', function (APP_CONFIG, AuthenticationService, AuthInterceptor, $translate) {
    return {

        text: {
            singular: $translate.instant('RMA.RMA_SINGLE'),
            plural: $translate.instant('RMA.RMA_PLURAL')
        },
